...
<body>
    ...
    <main style="margin: 10px auto;">
        ...
        <form action="../vistas/procesar_crear_cuenta.php" method="POST">
            Email: <input class="textinput" type="email" name="email" value="" required><br>
            Usuario: <input class="textinput" type="text" name="user" value="" required><br>
            Contraseña: <input class="textinput" type="text" name="pass" value="" required><br>
            <div style="font-size: 18px; font-weight: bold; margin: 0px 0px 10px">
                Datos bancarios:
            </div>
            Tarjeta de crédito: <input class="textinput" type="text" name="card" value="" required><br>
            Número secreto: <input class="textinput" type="number" name="cardnum" value="" required><br>
